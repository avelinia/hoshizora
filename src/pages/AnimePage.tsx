...
export function AnimePage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery<LegacyAnimeInfoResponse, Error>({
    queryKey: ["anime", id],
    queryFn: () => {
  ...
  const hasCharacters =
    extraInfo?.animechar &&
    Array.isArray(extraInfo.animechar) &&
    extraInfo.animechar.length > 0;
  const hasSeasons =
    extraInfo?.season &&
    Array.isArray(extraInfo.season) &&
    extraInfo.season.length > 0;
  const hasRecommendations =
    Array.isArray(animeInfo.recommendation) &&
    animeInfo.recommendation.length > 0;
        ...
        <div className="relative h-[500px] overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              filter: `blur(16px) ${
                isDark ? "brightness(0.4)" : "opacity(50%)"
              }`,
              transform: "scale(1.1)",
            }}
          />
