...
export default function Player({
  ...
  return (
    ...
    >
      ...
      {/* Controls Overlay */}
      <div
        className={`absolute inset-0 flex flex-col justify-between bg-linear-to-t from-black/80 via-transparent to-black/80 transition-opacity duration-300 ${
      ...
      >
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                style={{
                  ...
                  } ${volume * 100}%, rgba(255,255,255,0.2) ${volume * 100}%)`,
                }}
              />
            </div>
            ...
            {/* Subtitle Toggle */}
            <button className="p-2 rounded-lg hover:bg-white/10 text-white ml-auto">
