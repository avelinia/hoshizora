  ...
  const handleSaveProfile = () => {
    try {
      ...
      addNotification({
        ...
        message:
          "There was an error saving your profile settings. Please try again.",
      });
    }
  };
  ...
  useEffect(() => {
    const loadAppInfo = async () => {
      try {
        ...
        const osTypeValue = await osType();
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{
              backgroundColor: `${currentTheme.colors.background.main}90`,
            }}
            onClick={onClose}
          />
            ...
            <div className="flex h-full">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    borderTop: `1px solid ${currentTheme.colors.background.hover}`,
                    color: currentTheme.colors.text.secondary,
                  }}
                >
                  <div>Hoshizora v{appInfo.version}</div>
                  <div className="mt-1">
                              ...
                              >
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1 text-left">
                                    ...
                                    >
                                      A {theme.name.toLowerCase()} inspired
                                      theme
                                    </div>

                                    {/* Theme Preview */}
                                    <div className="mt-4 grid grid-cols-5 gap-2">
                                      {Object.entries(theme.colors.accent).map(
                                        ([key, color]) => (
                                          <div
                                            key={key}
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div>
                              ...
                              >
                                ...
                                <br />
                                Maximum size: 20MB. Supported formats: JPEG,
                                PNG, WebP
                              </p>
                            </div>
                          </div>
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          ...
                          <button className="px-4 py-2 rounded-lg bg-red-500/10 text-red-400 transition-colors duration-200 hover:bg-red-500/20">
                            Reset All Data
                          </button>
                        </div>
                      </div>
