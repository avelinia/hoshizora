...
export default function Toast() {
    ...
    useEffect(() => {
        const handleShowToast = (event: CustomEvent<{ notification: { id: string } }>) => {
                                    ...
                                    >
                                        <div
                                            ...
                                            style={{
                                                ...
                                                opacity: 0.7,
                                                animation: `${TOAST_DURATION}ms linear progress`,
                                                animationPlayState: hoveredId === notification.id ? 'paused' : 'running'
                                            }}
                                        />
                                    </div>
                                </div>
